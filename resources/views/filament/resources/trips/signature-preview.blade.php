...
@if ($trip && $trip->signature)
    <div class="flex flex-col items-center justify-center space-y-4 p-2">
        <div 
            class="w-full flex items-center justify-center rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 ring-1 ring-black/5"
        ...
        >
            <img 
                ...
                class="max-h-48 w-auto max-w-full rounded-lg object-contain"
                style="background-color: #ffffff !important;"
            />
        </div>
        ...
        <div class="w-full grid grid-cols-1 sm:grid-cols-2 gap-3 p-3 bg-gray-50 dark:bg-gray-800/60 rounded-lg text-sm border border-gray-200 dark:border-gray-700">
            <div>
                ...
                <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $trip->signature->signer_name }}</span>
            </div>
            <div>
