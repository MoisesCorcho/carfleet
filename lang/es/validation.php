...
return [
    ...
    'attributes' => [
        ...
        'license_expires_at' => 'fecha de vencimiento de licencia',
        'status' => 'estado operacional',
        'user_id' => 'cuenta de usuario',
        ...
        'vehicle_type' => 'tipo de carrocería',
        'company_name' => 'razón social',
        'name' => 'nombre',
        'origin' => 'origen',
        'destination' => 'destino',
        'scheduled_departure_at' => 'fecha y hora de salida programada',
        'scheduled_arrival_at' => 'fecha y hora de llegada programada',
        'notes' => 'observaciones',
        'reason' => 'motivo',
    ],
];
