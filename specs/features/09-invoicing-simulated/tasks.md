...
- [x] 2. Lógica de Dominio y PDF
  - [x] 2.1 Implementar Action `GenerateInvoiceAction`. _(cubre R1)_
  - [x] 2.2 Crear plantilla Blade de factura PDF. _(cubre R1)_

- [x] 3. Interfaz Administrativa (Filament v4)
  - [x] 3.1 Crear `InvoiceResource` con acción de descarga de PDF. _(cubre R1)_

- [x] 4. Pruebas Automatizadas
  - [x] 4.1 Feature test: Consolidación de viajes cerrados y generación de consecutivo de factura. _(cubre R1)_
