...
class FuelLogsRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Historial de Tanqueos y Combustible';
        ...
        return $schema
            ->components([
                ...
                FileUpload::make('voucher_photo_path')
                    ...
                    ->key(fn (Get $get): string => 'voucher_veh_'.($get('photo_source') ?? 'camera'))
                    ->disk('public')
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('trip.code')
                    ...
                    ->badge()
                    ->color('gray')
                    ->placeholder('Tanqueo en Patio / Base')
                    ->searchable(),
